      ...
      <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
          ...
          <li>
            ...
            <ul className="collapse show nav flex-column ms-1" id="submenu1" data-bs-parent="#menu">
              <li className="w-100">
                ...
                <a href="#" className="nav-link px-0"> <span className="d-none d-sm-inline">Data Pengunjung</span></a>
                </Link>
              </li>
              <li>
                <Link href="/admin/createpengunjung">
                <a href="#" className="nav-link px-0"> <span className="d-none d-sm-inline">Tambah Pengunjung</span></a>
                </Link>
              </li>
            </ul>
          </li>
        ...
        <div className="dropdown pb-4">
          <a href="#" className="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <span className="d-none d-sm-inline mx-1">Yanto Bogeng</span>
          </a>
